...
/**
 * Abstract class representing the basic functions and properties for an entity
 * in the game
 */
public abstract class Character {
    ...
    /**
     * Constructor to create an object of type character with a specified x and
     * y coordinate
     *
    ...
    /**
     * Abstract method for attacking that all child classes will implement in
     * different ways
     *
     * @param chr1 A character type object that the current object will deal
     * damage to
     */
